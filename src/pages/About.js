    ...
    <div className='about-layout'>
      <div className='profile-frame1'>
        <div className='profile-image'>
          <img src={ProfilePic} alt='Profile Pic 1' className='profile-pic' loading='lazy' />
          <img src={ProfilePic2} alt='Profile Pic 2' className='profile-pic' loading='lazy' />
          <img src={ProfilePic3} alt='Profile Pic 3' className='profile-pic' loading='lazy' />
          <img src={ProfilePic4} alt='Profile Pic 4' className='profile-pic' loading='lazy' />
          <img src={ProfilePic5} alt='Profile Pic 5' className='profile-pic' loading='lazy' />
        </div>
