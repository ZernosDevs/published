  ...
  return (
    <main className='fade-in'>
      ...
      <div className='lead-banner'>
        <img src={UnibuzzBanner} alt="Unibuzz project banner" loading='lazy' />
      </div>
